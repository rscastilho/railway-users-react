        ...
        <div className={`${styles.container}`}>
            <form>
                ...
                <div className={`${styles.fields}`}>
                    ...
                    <input type="password" value={confirmarPassword} onChange={e => setConfirmarPassWord(e.target.value)} placeholder="Confirme sua senha" />
                </div>
                ...
                <div className={`${styles.buttons}`}>
                    ...
                    <button onClick={e => navigate('/')} style={{ display: `${isloading ? 'none' : ''}` }}>
                        Voltar
                    </button>
                </div>
            </form>
